...
function () {
  ...
  Hypercharged.prototype.addUrl = function (url, callback) {
    ...
    var validation = Joi["function"]().required().validate(callback);
  ...
  Hypercharged.prototype.render = function (options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      var _a, value, error, browser, page, _i, _b, url, exception_1, exception_2, content, jsdom, scripts, _c, scripts_1, script, parent_1;
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 11:
            ...
            scripts = jsdom.window.document.querySelectorAll("script:not([type]), script[type='text/javascript'], link[as='script']");

            for (_c = 0, scripts_1 = scripts; _c < scripts_1.length; _c++) {
              script = scripts_1[_c];
